"""Download the AT&T (ORL) face database into data/att/."""
...
def main() -> int:
    if already_present():
        ...
        return 0
    print("[download_att] downloading...")
    ...
    if not already_present():
        ...
        return 1
    print(f"[download_att] done: {EXPECTED_SUBJECTS} subjects, {EXPECTED_PER_SUBJECT} PGMs each.")
    return 0
