...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Step 1: NP-Pix (b in {2,4,8,16}) and NP-Blur (k in {15,45,99}) on AT&T. "
            "Outputs a 5-col pixel grid, a 4-col blur grid, and a 2800-row MSE/SSIM table."
        )
    )
    parser.add_argument("--data-root", default="data/att", help="AT&T dataset root")
    parser.add_argument("--out-dir", default="outputs", help="output root for figs/ and tables/")
